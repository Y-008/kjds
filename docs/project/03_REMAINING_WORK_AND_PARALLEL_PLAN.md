...
| BAS-090 | G1–G3 | 销售单触发采购与跨境巴士动态选仓 | 工程+供应链 | 严格分离 Listing、Ozon 销售单和供应商采购单；仅真实销售单建立无地址履约需求；跨境巴士路线固化后才出现国内仓并申请订单绑定采购审批；GOOL 规范为 GUOO，UNI 新连接失败关闭；地址不一致、三报价/CM3/Passport/独立审批缺失均阻断；事件不可变且无外部下单、支付或物流写操作；[工程证据](evidence/20260725_BAS_090_ORDER_TRIGGERED_FULFILLMENT.md) | BR-038、BR-049、BR-067、BAS-089 | DONE_ENGINEERING |

...
|---|---|---|---|---|
| G-1 | 可信工程基线 | 分层提交、PostgreSQL 迁移、API/UI smoke、实时状态 | 干净基线可复现；迁移到 0006；API/DB/UI 启动可证 | PASS |
...
- PostgreSQL 实际迁移到 `20260716_0006`，验证全新升级、回滚与重新升级路径。
- 通过专用临时数据库运行 PostgreSQL/API/UI smoke，并执行 31 项自动测试；同时验证源文件证据化、Ozon 暂存和正式事实晋升。

...
|---|---|---|---|---|
| G-1 | 可信工程基线 | 分层提交、PostgreSQL 迁移、API/UI smoke、实时状态 | 干净基线可复现；迁移到 0003；API/DB/UI 启动可证 | IN_PROGRESS |
...
- PostgreSQL 实际迁移到 `20260713_0003`，验证升级与回滚路径。
- 增加 PostgreSQL/API/UI smoke test；现有 13 项内存/SQLite 测试不能替代。
